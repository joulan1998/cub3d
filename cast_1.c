...
/*   Updated: 2025/03/13 17:16:34 by ael-garr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pos	*cal_v_d(t_root *root, float an, t_compass *cmps)
{
	...
	cal_intcep(&xtocheck, &ytocheck, *root->player->player_x, *root->player->player_y, an, true, create_compass(0, cmps->f_d, cmps->f_r, 0));
